...
import type { Application as Reference } from "express";
...
export module HTTP {
    ...
    export type Application = Reference;
    ...
    export module API {
        export type Request = Framework.Request;
        export type Response = Framework.Response;
        export type Next = Framework.NextFunction;
        export type Error = Framework.Errback;
        export type Router = Framework.Router;
        ...
        export type Handler = Framework.Handler;
        export type Callback = Framework.RequestHandler;

        export module Handlers {
            export type Simple = (req: IncomingMessage, res: http.ServerResponse) => void;
            export type Next = (req: IncomingMessage, res: http.ServerResponse, next: NextFunction) => void;
            export type Error = (err: any, req: IncomingMessage, res: http.ServerResponse, next: NextFunction) => void;
            export type Function = Simple | Next | Error;
            export type Pathing = string | RegExp | (string | RegExp)[];
        }
    }
}
