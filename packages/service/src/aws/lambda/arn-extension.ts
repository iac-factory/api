...
export default function Identifier( input: string ): Identification.ARN {
    ...
    function parse(): string[] {
        type Expression = {
            value: string;
            evaluation: RegExpExecArray | null;
            fields: string[];
        };
    ...
    function resource(): string | null {
        const partials = parse();

        return ( partials[ 5 ] ) ? String( partials[ 5 ] ) : null;
    }

    function method(): string | string[] | null {
    ...
    function id(): string | null {
        ...
        return ( arn && arn.resource ) ? arn.resource.split( "/" ).at( 0 ) as string : null;
    }

    function path(): string | null {
        const method = Method.type( String( input ) ) as string;
...
export module Identification {
    export abstract class ARN extends String {
        declare public abstract id?: string | null;
        declare public abstract region?: string | null;
        declare public abstract account?: string | null;

        declare public abstract service?: string | null;
        declare public abstract resource?: string | null;

        declare public abstract method?: string | string[] | null;
        declare public abstract path?: string | null;
